...
const courseToSupabase = (appCourse: Omit<Course, 'id'>) => ({
    ...
    // FIX: Coalesce undefined to null to match the database schema type (number | null) and fix type mismatch for insert operations.
    original_price: appCourse.originalPrice ?? null,
